...
public class Stroboscope extends JPanel implements DmxControlInterface, MouseListener, ChangeListener, ActionListener {
	...
	public Stroboscope(int dmxChannel) {
	...
	public void setLaser(boolean b) {
		laserButton.setEnabled(b);
	}

	public void toggleLaser() {
		laserButton.setEnabled(!laserButton.isEnabled());
	}

	public void toggle() {
		System.out.println("Stroboscope.toggle: NYI");
	}
}